...
| Категория | Что умеет |
|---|---|
| 🎙️ **Голос и диалог** | Нативный двусторонний аудио-поток через **Gemini Live API** с перебиванием (barge-in), голос **Fish Audio** или **Edge-TTS**. Режим «зажми и говори», выбор микрофона и динамиков, настройка паузы до конца фразы. |
