...
19. **`game_updater`** (Steam/Epic, 1101 строка) — обновление и установка игр.
...
Далее:     B10 ✅, B11 ✅ — уровень B закрыт целиком.
           Уровень C ✅ — закрыт тоже. Не взято только то, что в разделе
           «не брать»: аватар, game_updater, flight_finder, dev_agent
           и телефонный dashboard.
```
