...
_PC_KEYWORDS = [
    ...
    "open", "открой",
    # Weather
    "weather", "погода", "погод",
    # Search
    "search", "найди", "поищи",
    # Window control
    "сверни", "свернуть", "minimize", "рабочий стол", "разверни",
    "закрой окно", "переключи окно", "проводник", "диспетчер", "окно", "окна",
    # Camera & Vision
    "камер", "вебкам", "webcam", "сфоткай", "что рядом", "что вокруг", "что там происходит",
    "посмотри на экран", "что на экране", "экран", "vision", "проанализируй экран",
    # Obsidian & Notes
    "обсидиан", "obsidian", "заметк", "дневник",
    # Telegram sender
    "отправь в тг", "отправь в телеграм", "скинь в тг", "скинь в телеграм",
    # System
